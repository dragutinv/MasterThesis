function [thresh,cntR,sumR,cntP,sumP] = boundaryPRfast4SNR(pb,segs,nthresh)
...
if islogical(pb), 
  [thresh,cntR,sumR,cntP,sumP] = boundaryPR_NO_Morph(pb,segs,nthresh);
  return
end
...
for t = nthresh:-1:1,
  ...
  for i = 1:nsegs,
    ...
    [match1,match2] = correspondPixels(bmap,bmaps{i},0.008);
