function [ imgOut ] = improv_kmeans_segmentation( courtImage, debug )
...
%imshow(label2rgb(centerOfImage,'jet','w'));
%pause;
...
[~, maxSegment] = max([segment1count segment2count segment3count segment4count]);
